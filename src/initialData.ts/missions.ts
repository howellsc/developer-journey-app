...
export const missions: Mission[] = [
  ...
  },
  {
    id: "3ukaXbkeaBG2CXRMgIjl",
    title: "Pass GCP Exam",
    technologies: ['cloud_load_balancing', 'cloud_run', 'cloud_firewall_rules', 'virtual_private_cloud', 'compute_engine', 'artifact_registry'],
    learningResources: [
      {
        title: "Take GCP Exam",
        link: 'https://www.cloudskillsboost.google/paths/12'
      },
    ],
  },
];
